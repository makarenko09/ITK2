...
public class Seed4jSampleApplicationPageable {

  private final int page;
  private final int pageSize;
  private final int offset;

  public Seed4jSampleApplicationPageable(int page, int pageSize) {
  ...
  public boolean equals(Object obj) {
    ...
    Seed4jSampleApplicationPageable other = (Seed4jSampleApplicationPageable) obj;
